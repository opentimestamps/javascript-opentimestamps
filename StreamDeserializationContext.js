...
exports.read= function(l) {
    var output = resp_bytes.slice(counter, counter + l);
    counter += l;
    return output;
};
exports.read_bool= function(){
        var b = this.read(1)[0]
        if (b == 0xff){
            return true;
        }else if (b == 0x00){
...
exports.read_bytes = function(expected_length=undefined){
        if(expected_length==undefined){
            expected_length = this.read_varuint();
        }
        return this.read(expected_length);
    };
exports.read_varbytes = function(max_len, min_len=0){
...
exports.assert_magic = function (expected_magic){
