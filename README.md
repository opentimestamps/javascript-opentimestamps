...
const detached = OpenTimestamps.DetachedTimestampFile.deserialize( new OpenTimestamps.Context.StreamDeserialization(fileOts));
const infoResult = OpenTimestamps.info(detached);
console.log(infoResult);
```
...
const detached = OpenTimestamps.DetachedTimestampFile.fromBytes(new OpenTimestamps.Ops.OpSHA256(), file);
const detachedOts = OpenTimestamps.DetachedTimestampFile.deserialize( new OpenTimestamps.Context.StreamDeserialization(fileOts));
